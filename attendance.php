...
$table_name = "att_" . date("M_y");

// Check if the table already exists in the database
$stmt = $con->prepare("SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = ? AND TABLE_NAME = ?");
...
if ($stmt_result->num_rows < 1) {
    ...
    $stmt = $con->prepare("CREATE TABLE `$table_name` (
